...
module.exports.handler=async(event,callback,context)=>{
    ...
    const old_password = requestBody['USERNAME_OLD'];
    const new_password = requestBody['PASSWORD_NEW'];
    ...
    const query = `UPDATE Authentication SET password = '${new_password}' WHERE password = '${old_password}';`;
    const newUser = {
        username ,
        password ,
        role
